...
get_supabase_info() {
    ...
    if [ -f "supabase/config.toml" ]; then
        ...
        if [ -n "$project_id" ]; then
            ...
            echo "$project_url" | gh secret set TEST_SUPABASE_URL=https://<project-ref>.supabase.co
...
set_secret "TEST_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY

echo ""
echo "🤖 AI SERVICES CONFIGURATION"
echo "============================"
set_secret "TEST_OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
set_secret "OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
