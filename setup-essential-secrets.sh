...
read -r supabase_url
echo "$supabase_url" | gh secret set TEST_SUPABASE_URL=https://<project-ref>.supabase.co
echo "✅ Set TEST_SUPABASE_URL=https://<project-ref>.supabase.co
...
echo "$supabase_service_key" | gh secret set TEST_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY
echo "✅ Set TEST_SUPABASE_SERVICE_KEY=REDACTED_SUPABASE_SERVICE_ROLE_KEY

# OpenAI API Key
echo ""
echo "Enter your OpenAI API Key:"
read -s openai_key
echo "$openai_key" | gh secret set TEST_OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
echo "✅ Set TEST_OPENAI_API_KEY=REDACTED_OPENAI_API_KEY
