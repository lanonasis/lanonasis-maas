...
**Add/Verify:**
```
JWT_SECRET = <same value as in auth-gateway>
SUPABASE_URL = <your Supabase URL>
SUPABASE_SERVICE_KEY = <your Supabase service key>
```

**How to get JWT_SECRET from auth-gateway:**
```bash
ssh vps "grep JWT_SECRET /opt/lanonasis/onasis-core/services/auth-gateway/.env"
```
...
```bash
# Solution: Add JWT_SECRET to Netlify environment variables
...
1. **JWT_SECRET must match auth-gateway**: Same secret used to sign and verify
