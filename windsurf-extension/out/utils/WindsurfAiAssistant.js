...
exports.WindsurfAiAssistant = void 0;
const vscode = __importStar(require("vscode"));
class WindsurfAiAssistant {
    ...
    async showAssistantPanel() {
        ...
        this.panel = vscode.window.createWebviewPanel('LanOnasisAiAssistant', 'LanOnasis AI Memory Assistant', vscode.ViewColumn.Beside, {
            enableScripts: true,
    ...
    async handleCreateMemoryFromContext(data) {
        const editor = vscode.window.activeTextEditor;
        if (!editor)
            return;
        try {
    ...
    generateCodeAnalysis(code, language, similarPatterns) {
...
exports.WindsurfAiAssistant = WindsurfAiAssistant;
//# sourceMappingURL=WindsurfAiAssistant.js.map